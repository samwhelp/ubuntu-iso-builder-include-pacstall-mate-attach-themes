...
| `+` | `+` |
| [ubuntu-iso-builder-import-pacstall-mate-attach-themes](https://samwhelp.github.io/ubuntu-iso-builder-import-pacstall-mate-attach-themes/) | [GitHub](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-mate-attach-themes) |
| `=` | `=` |
| [ubuntu-iso-builder-include-pacstall-mate-attach-themes](https://samwhelp.github.io/ubuntu-iso-builder-include-pacstall-mate-attach-themes/) | [GitHub](https://github.com/samwhelp/ubuntu-iso-builder-include-pacstall-mate-attach-themes) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-include-pacstall-mate-attach-themes/tree/main/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-include-pacstall-mate-attach-themes/tree/main/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-include-pacstall-mate-attach-themes/tree/main/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-include-pacstall-mate-attach-themes](https://github.com/samwhelp/ubuntu-iso-builder-include-pacstall-mate-attach-themes)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-include-pacstall-mate-attach-themes.git
```


> change dir to `ubuntu-iso-builder-include-pacstall-mate-attach-themes`

``` sh
cd ubuntu-iso-builder-include-pacstall-mate-attach-themes
```
...
> The resulting ISO file will be placed on `ubuntu-iso-builder-include-pacstall-mate-attach-themes/dist`
